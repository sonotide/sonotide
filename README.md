...
Releases are published from git tags that match `v*`, for example `v0.4.0`.
...
```text
sonotide-0.4.0-windows-msvc-x64-release.zip
sonotide-0.4.0-windows-msvc-x64-release.zip.sha256
```
